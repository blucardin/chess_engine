...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    let pgn = br#"
    1. e4 Nc6 2. d4 e5 3. d5 Nce7 4. Nf3 Ng6 5. Bc4 Nf6 6. Nc3 Bc5 7. O-O h6 8. Be3 d6 9. Bxc5 dxc5 10. a3 a6 11. b4 b5 12. Bb3 c4 13. Ba2 Qd6
    {14. a4 O-O 15. axb5 Qxb4 16. Qd2 axb5 17. Rfb1 Qc5 18. Rxb5 Qd6 19. Rbb1 Rd8 20. Bxc4}
    "#;
    ...
    let black_box_board = std::hint::black_box(board);
    ...
    group.bench_function("Get All Moves for Turn Unchecked Iter", |b: &mut Bencher| {
        b.iter(|| black_box_board.get_all_moves_for_turn_unchecked_iter().collect::<Vec<Move>>())
    });
